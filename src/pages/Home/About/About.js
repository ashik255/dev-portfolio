...
import image from "../../../images/Ashik.png";
import AOS from 'aos';
        ...
        <section id="about" className="pt-4 pb-5 " style={{ backgroundColor: 'white', overflow: 'hidden' }} >
            ...
            <div className="container">
                <div className="mt-2 d-flex justify-content-around align-itmes-center flex-wrap ">
                    {
                        aboutInfo.map(info => <div className="border d-flex p-3 flex-column justify-content-around align-items-center" style={{ width: '200px', height: '225px', marginTop: '40px', overflow: 'hidden' }} key={info.id}>
                            <div className="border h-100" style={{ width: '65%' }}>
                                <FontAwesomeIcon  size='5x' variant='top' icon={info?.icon} />
                ...
                <div className="row">
                    <div className="col-md-6 mt-5 d-flex flex-column justify-content-center align-items-center">
                        ...
                        <div data-aos="fade-up">
                            ...
                            <p className="text-center">I am A Full Stack Web-Developer. I have Serious passion for making Interactive Websites. Currently I am working with <span style={{ color: '#05C2C1', fontStyle: 'bold' }}>Full-stack Project</span> .</p>
                        </div>
                    </div>
